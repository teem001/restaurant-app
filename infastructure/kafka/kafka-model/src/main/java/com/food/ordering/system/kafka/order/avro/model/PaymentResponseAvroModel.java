...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public PaymentResponseAvroModel(String id, String paymentId, String sagaId, String customerId, String orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessage) {
        this.id = id;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 7:
                ...
                break;
            case 8:
                failureMessage = (java.util.List<java.lang.String>) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
        ...
        public PaymentResponseAvroModel build() {
            try {
                ...
                record.paymentId = fieldSetFlags()[1] ? this.paymentId : (String) defaultValue(fields()[1]);
                record.sagaId = fieldSetFlags()[2] ? this.sagaId : (String) defaultValue(fields()[2]);
