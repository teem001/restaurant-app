...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RestaurantApprovalResponseAvroModel(String id, String sagaId, String restaurantId, String orderId, com.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessage, java.time.Instant createdAt) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: restaurantId = (String)value$; break;
    case 3: orderId = (String)value$; break;
    case 4: orderApprovalStatus = (com.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus)value$; break;
    case 5: failureMessage = (java.util.List<java.lang.String>)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[5], other.failureMessage)) {
        this.failureMessage = data().deepCopy(fields()[5].schema(), other.failureMessage);
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.failureMessage = fieldSetFlags()[5] ? this.failureMessage : (java.util.List<java.lang.String>) defaultValue(fields()[5]);
