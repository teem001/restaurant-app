...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RestaurantApprovalRequestAvroModel(UUID id, String sagaId, UUID restaurantId, UUID orderId, RestaurantOrderStatus restaurantOrderStatus, java.util.List<com.food.ordering.system.kafka.order.avro.model.Product> products, BigDecimal price, java.time.Instant createdAt) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: id = (UUID)value$; break;
    case 1: sagaId = (String) value$; break;
    case 2: restaurantId = (UUID)value$; break;
    case 3: orderId = (UUID)value$; break;
    ...
    case 6: price = (BigDecimal)value$; break;
   ...
   * @param value the value to set.
   */
  public void setRestaurantId(UUID value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setId(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public RestaurantApprovalRequestAvroModel.Builder setSagaId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantId(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setOrderId(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setPrice(BigDecimal value) {
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.id = fieldSetFlags()[0] ? this.id : (UUID) defaultValue(fields()[0]);
        record.sagaId = fieldSetFlags()[1] ? this.sagaId : (String) defaultValue(fields()[1]);
        record.restaurantId = fieldSetFlags()[2] ? this.restaurantId : (UUID) defaultValue(fields()[2]);
        record.orderId = fieldSetFlags()[3] ? this.orderId : (UUID) defaultValue(fields()[3]);
        record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus : (RestaurantOrderStatus) defaultValue(fields()[4]);
        record.products = fieldSetFlags()[5] ? this.products : (List<Product>) defaultValue(fields()[5]);
        record.price = fieldSetFlags()[6] ? this.price : (BigDecimal) defaultValue(fields()[6]);
        record.createdAt = fieldSetFlags()[7] ? this.createdAt : (Instant) defaultValue(fields()[7]);
        return record;
