package com.food.ordering.system.kafka.consumer.kafka.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase>{
    ...
    public Map<String, Object> producerConfig(){
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, kafkaConsumerConfigData.getKeySerializerClass());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, kafkaConsumerConfigData.getValueSerializerClass());
